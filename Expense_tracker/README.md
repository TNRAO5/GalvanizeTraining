...
```
cd existing_repo
git remote add origin https://gitlab.galvanize.com/narayana.r.tangudu.mu1w/financialtracker.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.galvanize.com/narayana.r.tangudu.mu1w/financialtracker/-/settings/integrations)
